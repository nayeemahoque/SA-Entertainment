<?php
require_once(__DIR__ . '/../../controller/admin/approved_book_controller.php');
...
<head>
    <title>Admin | Approved Books</title>
    ...
    <table class="container-table">
        ...
        ?>
            <tr>
                ...
                <td class="w-20">
                    <a href="../../controller/admin/delete_book_controller.php?title=<?php echo $title ?>">Delete</a>
                    <a href="../../controller/admin/approve_book_controller.php?title=<?php echo $title ?>">Approve</a>
                </td>
              </tr>
        <?php
        }

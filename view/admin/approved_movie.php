<?php
require_once(__DIR__ . '/../../controller/admin/approved_movie_controller.php');
...
$movie = getUploadedMovies();
?>

<html>

<head>
    <title>Admin | Approved Movie</title>
    ...
    <table class="container-table">
        ...
        ?>
            <tr>
                ...
                <td class="w-20">
                    <a href="../../controller/admin/delete_movie_controller.php?title=<?php echo $title ?>">Delete</a>
                    <a href="../../controller/admin/approve_movie_controller.php?title=<?php echo $title ?>">Approve</a>
                </td>
            </tr>
        <?php
        }

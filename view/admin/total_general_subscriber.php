<?php
require_once(__DIR__ . '/../../controller/admin/total_general_subscriber_controller.php');
...
$G_user = getTotalGeneralSubscriber();
?>

<html>

<head>
    <title>Admin | Total General Subscriber</title>
...
<body>
    <table class="container-table">
        ...
        <tr>
            <td>
            <h2><u>Total General Subscriber's List>></u></h2>
            </td>  
        </tr>
        <tr align="left">  
        ...
        while ($row = mysqli_fetch_assoc($G_user)) {
            $name = $row['Name'];
            $email = $row['Email'];
            $gender = $row['Gender'];
            $type = $row['Type'];

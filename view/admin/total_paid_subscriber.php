<?php
require_once(__DIR__ . '/../../controller/admin/total_paid_subscriber_controller.php');
...
$series = getTotalPaidSubscriber();
?>

<html>

<head>
    <title>Admin | Total Paid Subscriber</title>
...
<body>
    <table class="container-table">
        ...
        <tr>
            <td>
            <h2><u>Total Paid Subscriber's List>></u></h2>
            </td>  
        </tr>
        <tr align="left">  

...
<head>
    <title>Content Creator | Upload Movie</title>
    <link rel="stylesheet" href="../../assets/style.css">
    <script src="../../script/content_creator/upload_movie.js"></script>
</head>
...
<body>
    <table class="container-table">
        <tbody>
            ...
            <tr>
                <td colspan="5">
                    <form method="post" action="../../controller/content_creator/upload_movie_controller.php" enctype="multipart/form-data">
                        <table class="w-100">
                            <tr>
                                <td class="w-25"></td>
                            ...
                            <tr>
                                ...
                                <td class="w-25">
                                    <input type="file" id="movieFile" name="movieFile" value="" onblur="validateMovieFile()"  accept=".mp4" required />
                                </td>
                                <td class="w-25"></td>
                            </tr>
                            <tr>

...
<head>
    <title>Content Creator | Upload TV Series </title>
    <link rel="stylesheet" href="../../assets/style.css">
    <script src="../../script/content_creator/upload_tv_series.js"></script>
</head>
...
<body>
    <table class="container-table">
        <tbody>
            ...
            <tr>
                <td colspan="5">
                    <form method="post" action="../../controller/content_creator/upload_tv_series_controller.php" enctype="multipart/form-data">
                        <table class="w-100">
                            <tr>
                                <td class="w-25"></td>
                            ...
                            <tr>
                                ...
                                <td class="w-25">
                                    <input type="file" id="seriesFile" name="seriesFile" value="" onblur="validateSeriesFile()" accept=".mp4" required />
                                </td>
                                <td class="w-25"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="w-25"></td>
                                <td class="w-25">
                                    <input type="submit" id="submit" name="submit" value="Upload Series" />
                                </td>
                                <td class="w-25"></td>
                            </tr>
                        </table>

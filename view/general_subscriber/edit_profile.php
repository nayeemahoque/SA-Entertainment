<?php
require_once(__DIR__ . '/../../controller/general_subscriber/profile_controller.php');
...
<head>
    <title>General Subscriber | Edit Profile</title>
...
<body>
    <table class="container-table">
        <tbody>
            ...
            <tr>
                <td colspan="5">
                    <form method="post" action="../../controller/general_subscriber/edit_profile_controller.php" enctype="multipart/form-data">
                        <table>
                            <tr>

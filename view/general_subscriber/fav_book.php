<?php
require_once(__DIR__ . '/../../controller/general_subscriber/fav_book_controller.php');
...
$books = getGeneralSubscriberFavBooks();
?>

<html>

<head>
    <title>General Subscriber | Favorite Books</title>

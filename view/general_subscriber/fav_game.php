<?php
require_once(__DIR__ . '/../../controller/general_subscriber/fav_game_controller.php');
...
$games = getGeneralSubscriberFavGames();
?>

<html>

<head>
    <title>General Subscriber | Favorite Games</title>

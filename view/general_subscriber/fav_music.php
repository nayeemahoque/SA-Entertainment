<?php
require_once(__DIR__ . '/../../controller/general_subscriber/fav_music_controller.php');
...
$music = getGeneralSubscriberFavMusic();
?>

<html>

<head>
    <title>General Subscriber | Favorite Music</title>

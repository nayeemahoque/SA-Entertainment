<?php
require_once(__DIR__ . '/../../controller/general_subscriber/fav_tv_series_controller.php');
...
$series = getGeneralSubscriberFavTvSeries();
?>

<html>

<head>
    <title>General Subscriber | Favorite TV Series</title>

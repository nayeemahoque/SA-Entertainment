<?php
require_once(__DIR__ . '/../../controller/general_subscriber/game_controller.php');
...
$games = getGeneralSubscriberGames();
?>

<html>

<head>
    <title>General Subscriber | Games</title>
    ...
    <table class="container-table">
        ...
        ?>
            <tr>
                ...
                <td class="w-20">
                    <a href="<?php echo $filePath . ".zip" ?>">Download</a>&nbsp;&nbsp;&nbsp;
...
<script>
    function addToFavAjax(title, email) {
        ...
        xhttp.open('POST', '../../controller/general_subscriber/add_fav_game_controller.php?', true);
